...
| chain_id | 체인 | RPC |
|----------|------|-----|
| `56357` (기본) | KCP | `https://rpc.kcp.world` |
| `43113` | Fuji | `https://api.avax-test.network/ext/bc/C/rpc` |
...
- **2026-05-17T13:24:09.200Z** [INFO] `adapter` · reqId=abc-123
  sending tx to chain (chainId=56357)
...
| `chain_id` | string | | `56357` | 체인 ID (KCP) |
...
- **인덱스 패턴**: `s*,w*,l*,m*,d*,a*,t*` (모든 서비스 로그). 특정 서비스만 필터는 로그의 `service.name` 필드로 자동 구분
